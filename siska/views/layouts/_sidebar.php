                ...
                'items' => [
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            ['label' => 'Staf', 'icon' => 'user', 'url' => ['/']],
                            ['label' => 'Mata Kuliah', 'icon' => 'book', 'url' => ['/']],
                            ['label' => 'Status Dosen', 'icon' => '', 'url' => ['/status-dosen']],
                            ['label' => 'Jabatan Struktural', 'icon' => '', 'url' => ['/']],
                            ['label' => 'Jenjang Pendidikan', 'icon' => '', 'url' => ['/jenjang-pendidikan']],
                            ['label' => 'Universitas', 'icon' => '', 'url' => ['/universitas']],
                        ],
                    ],
